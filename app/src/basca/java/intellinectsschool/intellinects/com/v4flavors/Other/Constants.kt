...
object Constants {
   ...
   // var SCHOOL_ID = "187"
    ...
    //URLS
     val IP_ADDRESS = "https://isirs.org/intellinect_dashboard"
     val BASE_URL = "/WS/index_main.php"
    val LOG_API = "https://isirs.org/intellinect_dashboard/WS/log_api.php"

    var FEEPOLICY_URL = "https://intelliadmissions.org/fee-policy"
    ...
    const val MASTER_API_URL="https://apps.intellinects.com/masterapi/public/api/"
     val MORE_NEWS_URL = "https://basca.in/news/news-from-basca/"
    val FACILITIES_URL = "https://basca.in/"

     val LEARNING_CENTER = "https://moodle.cjmkharghar.org/login/index.php?mob_mobileno=admin&mob_random_key=taraba_cjm&mob_emailid=ranjan@palinfocom.net&mob_password=1234"
     val PRINCIPALS_MESSAGE ="https://basca.in/"
    val TEACHERS_URL = "https://basca.in/about-us/managing-committee/"
    val ROLL_OF_HONOUR="https://basca.in/"
    val YOUTUBE_EDU_URL = "https://basca.in/"


    val NSCG_URL = "https://basca.in/our-priorities/neighbourhood-senior-citizen-groups/"
    val DIRECTOR_MESSAGE_URL = "https://basca.in/about-us/spiritual-directors-message/"

    val POSITIVE_AGEING_URL = "https://basca.in/our-priorities/positive-ageing/"
    val COMP_LITERACY_URL = "https://basca.in/our-priorities/senior-computer-literacy-programme/"
    val MANAGING_TEAM_URL = "https://basca.in/about-us/managing-committee/"
    val DEANERY_CONTACTS_URL = "https://basca.in/about-us/deanery-co-ordinators/"
    val SCHOOL_WEBSITE = "https://basca.in/"
    val CONTACT_US = "https://basca.in/contact-us/"
    val ABOUT_US = "https://maryimmaculateprimaryborivli.org/about-us/"
    val FAQ_URL = "https://intellischools.org/contact-us/faqs/"
