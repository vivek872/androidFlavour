...
object Constants {
    ...
    val EXTENSIONS_SUPPORTED = arrayOf(
        "pdf",
        "PDF",
        "jpg",
        "JPG",
    ...
    val FILE_EXTENSIONS_SUPPORTED =
        arrayOf("pdf", "PDF", "doc", "docx", "xls", "xlsx", "ppt", "pptx", "rtf", "txt", "numbers", "pages", "keynote")
    ...
    val LEARNING_CENTER =
        "https://moodle.cjmkharghar.org/login/index.php?mob_mobileno=admin&mob_random_key=taraba_cjm&mob_emailid=ranjan@palinfocom.net&mob_password=1234"
    val LMS_URL = "https://ilms.intellinects.net/LMS_PARENT/pages/Subject.php"


    //URLS

    val TERMS_URL = "https://holynamehighschool.org/terms-of-app-use-privacy-policy/"
    val MORE_NEWS_URL = "https://holynamehighschool.org/news/news-around-campus/"
    val SCHOOL_DOMAIN = "https://holynamehighschool.org/"
    val FACILITIES_URL = "https://holynamehighschool.org/facilities/"
    val PRINCIPALS_MESSAGE = "https://holynamehighschool.org/about-us/principals-message/"
    val CONTACT_US = "https://holynamehighschool.org/contact-us/"
    val ABOUT_US = "https://holynamehighschool.org/about-us/"
    val SCHOOL_WEBSITE = "https://holynamehighschool.org/"
